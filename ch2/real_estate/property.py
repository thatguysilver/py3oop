class Property:
    def __init__(self, square_feet = '', beds = '', baths = '', **kwargs):
        #super().__init__(**kwargs)      #Just in case we add a superclass.
    ...
    '''
    staticmethod is a purely organization or stylistic feature. It allows us to
    put a fn that normally would not be inside a class, inside a class. I'm
    not sure why the author preferred it this way, to be honest. Note the lack
    of a self argument in prompt_init(). It belongs to the class, not the object.
    Not the same as a classmethod.
    '''
